...
const Impressum = () => {
  return (
    <div className="flex flex-col gap-10 justify-center items-center mx-2 sm:mx-56 mt-12">
      <div>
        <h1 className="font-extrabold text-7xl">Impressum</h1>
      </div>
      <div className="flex flex-col gap-5 items-start">
        <p>
          <span className="font-bold">Angaben gemäß § 5 TMG</span> Cliff Asare
          Berater im Bereich Sportmanagement [Adresse des Geschäftsstandorts]
          [Postleitzahl, Stadt]
        </p>
        <div>
          <p>
            <b> Kontakt Telefon:</b> [Telefonnummer]
          </p>
          <p>
            <b>E-Mail:</b> [E-Mail-Adresse]{" "}
          </p>
          <p>
          ...
          <p>
            ...
            [Falls zutreffend, ID hier einfügen]
          </p>
        </div>
        Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV [Name des
        Verantwortlichen] [Adresse des Verantwortlichen]
        <p>
          Hinweis auf EU-Streitschlichtung Die Europäische Kommission stellt
          eine Plattform zur Online-Streitbeilegung (OS) bereit:
          https://ec.europa.eu/consumers/odr/.
        </p>
        <p>
          Unsere E-Mail-Adresse finden Sie oben im Impressum. Haftungsausschluss
          (Disclaimer) Haftung für Inhalte Als Diensteanbieter sind wir gemäß §
